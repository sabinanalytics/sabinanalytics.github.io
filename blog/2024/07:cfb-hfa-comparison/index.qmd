...
College Football fans (including me) cannot wait until the new College Football 25 video game to come out. As part of the game there are team rankings provided by EA sports in addition to rankings of the [25 hardest places to play](https://www.ea.com/games/ea-sports-college-football/college-football-25/news/college-football-25-rankings-week-showcase).

The top of the list is a who's who of college football. EA Sports mentions the rankings of the toughest places to play come from a combination of "home winning %, home game attendance, active home winning streaks, team prestige, and more."

![](images/ea_top10_toughest.png)

The top 10 venues listed by EA Sports are in the top 20 in total capacity across College Football.
...
Alabama's winning percentage at home in the Nick Saban era (2007-2023) was 93% which is the highest of any FBS team in that timespan.

So is Bryant-Denney Stadium a particularly hard place to play? In short of course it is. Just look at how rarely Alabama has lost there. But there's no evidence that it is any more difficult of a place to play than the average college football home venue. Don't believe me? Well in 21 neutral site games over that same time Alabama had a 95% winning percentage and even had a 84% winning percentage on the road. So while 84% on the road is worse, Alabama's road schedule is almost exclusively against SEC teams while they typically would have one or two non-power conference (including FCS) home games each year.

Well they do boast a raucous crowd, it can be very hot and humid, but the most difficult thing about winning in Tuscaloosa is the players wearing crimson on the field, not the stadium or the crowd.
...
Fans, weather conditions, or even elevation can then be considered part of a team's unique HFA.
...
Here I add in the latitude, longitude, and elevation for the stadium where the game is played and each respective team's home stadium. Using that I can calculate the distance traveled for each team and any effects of elevation. I can also calculate the capacity for the game and if that is much different than the home capacity for a team. For the purposes of this study I will not include elevation or capacity differences as that can reasonably be part of the home field effect. I will include travel distance and changes in timezone as that, to me, has less to do with a home field effect and more to do with conferences, how they are spread out, or if a team happens to be located geographically far away from those on its schedule.
...
The estimated average home field advantage for all teams from 2005 to 2023 is `r round(avg_hfa$mean, digits = 2)` points per drive for the home team.

While I make estimates for average team ability since 2005 in all seasons of the dataset and each venue they played at in that timespan, I am only assessing the most recent stadium a team has played in for the following analysis if a team has had more than one home stadium since 2005.
...
One way to normalize this is to multiply the average number of drives per game on these effects to see the estimate points per game effect of a stadium. We see even for Army which has the largest additional home field effect, this comes out to 2.2 points per game which is about double the estimated average home field advantage effect of `r round(avg_drive_game*avg_hfa$mean*2, digits = 1)` points per game (assuming an average number of drives per game).
...
This also brings up another point which is that this model solely measures how teams *play* at their home compared to the average home field advantage. For Army this could be for reasons around the strict routine of West Point vs the road.
...
It's one thing to have a ranking of teams, but is this effect real or is it just a ranking because you have to order teams in **some** way?
